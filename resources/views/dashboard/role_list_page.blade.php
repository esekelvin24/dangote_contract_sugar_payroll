                ...
                <div class="col-sm-12">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark">Role Table</h6>
                            </div>
          ...
          table = $('#datable_1').DataTable({
                     ...
                     // serverSide: true,
                        ...
                        columns: [
                            ...
                            {data: null, orderable: false, searchable: false,
                            render: function(data){
                             return data.role_enable==1?"Enabled":"Disabled";
                            }
                            ...
                            {data: null, orderable: false,searchable: false,
                            render: function(data){
                                    var edit_button = '<a id="' + data.id + '" href="javascript:void(0);" class="text-primary"><icon class="fa fa-pencil"></icon> </a>';
            ...
            //individual checking of checkbox
                ...
                function take_action_blk(id)
                {
                    ...
                    $.ajax({
                        type: "get",
                        url: SITEURL + "/role-list/delete/"+app_ids,
