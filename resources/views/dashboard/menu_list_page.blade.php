...
<div class="container-fluid">
    ...
    <div class="row heading-bg">
            ...
            <h5 class="txt-dark">Menu List</h5>
            </div>
            <!-- Breadcrumb -->
          ...
          table = $('#datable_1').DataTable({
                     ...
                     // serverSide: true,
                        ...
                        columns: [
                            ...
                            render: function(data){
                                    var checkbox = '<div class="checkbox"><input onClick="ff()" value="'+ data.menu_id +'" type="checkbox"><label for="checkbox1"></label></div>';
                                    return checkbox;
                                }
                            },           
                            {data: 'menu_id', name: 'menu_id'},
                            {data: 'menu_name', name: 'menu_name'},
                            {data: 'menu_url', name: 'menu_url', orderable: false, searchable: false},
                            {data: 'parent_id', name: 'parent_id', orderable: false, searchable: false},
                            {data: 'icon_class', name: 'icon_class', orderable: false,searchable: false},
                            {data: 'menu_level', name: 'menu_level', orderable: false,searchable: false},
                            {data: 'sub_menu', name: 'sub_menu', orderable: false,searchable: false},
                            {data: 'created_at', name: 'created_at', orderable: false,searchable: false},
                            {data: null, orderable: false,searchable: false,
                            render: function(data){
                                    var edit_button = '<a id="' + data.menu_id + '" href="javascript:void(0);" class="text-primary"><icon class="fa fa-pencil"></icon> </a>';
                                    var delete_button = '<a id="' + data.menu_id + '" onclick="take_action_blk(\''+data.menu_id+'\')" href="javascript:void(0)" class="text-danger"><icon class="fa fa-trash"></icon> </a>';
            ...
            //individual checking of checkbox
                ...
                function take_action_blk(id)
                {
                    ...
                    $.ajax({
                        type: "get",
                        url: SITEURL + "/menu-list/delete/"+app_ids,
