...
<div class="container-fluid">
    ...
    <div class="panel-wrapper collapse in">
            ...
            <div class="row">
                 ...
                 <a href="{{url('user-list/new-user?op=edit&id='.$user_list->first()->id)}}"><button type="button" class="btn btn-sm btn-flat btn-default"><span class="btn-label"><i class="fa fa-edit"></i></span> Edit</button></a>
                         ...
                         <table id="tblmarketerinfo" class="table table-bordered"> 
                            ...
                            @foreach($user_list as $user)
                                                    ...
                                                    <tbody>
                                                     ...
                                                     <tbody>
                                                         <tr class="even pointer">
                                                             <th scope="row" bgcolor="#F5F7FA">Change Password at login</th>
                                                             <td class="pull-xs-left col-sm-9 col-xs-8">{{$user->passchg_logon=="1"?"Yes":"No"}}</td>
                                                         </tr>
                                                     </tbody>
                 
                                                   <tbody>
                                                     <tr class="even pointer">
                                                         <th scope="row" bgcolor="#F5F7FA">User Locked </th>
                                                         <td class="pull-xs-left col-sm-9 col-xs-8">{{$user->user_lock=="1"?"Yes":"No"}}</td>
                                                     </tr>
                                                 </tbody>
                 
                                                 <tbody>
                                                     <tr class="even pointer">
                                                         <th scope="row" bgcolor="#F5F7FA">User disabled </th>
                                                         <td class="pull-xs-left col-sm-9 col-xs-8">{{$user->user_disabled=="1"?"Yes":"No"}}</td>
                                                     </tr>
                                                 </tbody>
                                                  ...
                                                  <tbody>
                                                     <tr class="even pointer">
                                                         <th scope="row" bgcolor="#F5F7FA">Authorized Login Days</th>
                                                         <td class="pull-xs-left col-sm-9 col-xs-8">{{$login_days}}</td>
                                                     </tr>
                                                 </tbody>
                                                 ...
                                                 <tbody>
                                                     <tr class="even pointer">
                                                         <th scope="row" bgcolor="#F5F7FA">Role</th>
                                                         <td class="pull-xs-left col-sm-9 col-xs-8">
                                                              {{$role_name}}            
                                                         </td>
                                                     </tr>
