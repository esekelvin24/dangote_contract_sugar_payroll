...
<div class="box-body">
  <form id="form-regularization">
        ...
        <table id="tblmarketerinfo" class="table table-bordered"> 
                 ...
                 @permission(('can-approve-regularisation-hod')) 
                          @if(!isset($hr_approval_proc->user_hr_approver->name))
                                  <div class="btn-group" data-toggle="buttons" class="col-sm-4">  
                                  
                                  <button class="btn btn-success" type="button" name="pen_is_retired" id="option1"      onclick="call_hod_approval_status_fun('1');" ><i class="fa fa-check"></i>Approve</button>
               ...
               @permission(('can-approve-regularisation-hr')) 
                          @if(isset($hod_approval_proc->user_hod_approver_id_actual->name))
                                  ...
                                  <button class="btn btn-success" type="button" name="pen_is_retired" id="option1"    onclick="call_hr_approval_status_fun('1');" ><i class="fa fa-check"></i>Approve</button>
