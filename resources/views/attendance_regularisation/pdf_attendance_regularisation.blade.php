            ...
            <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 brandSection" style="background-color: #3B99B3;border: 1px solid #417482">
                <div class="row">
					...
					@foreach($attendances as $sn => $attendance) 
						...
						<td style="padding: 4px; border: 1px solid black;">{{ $attendance->start }}</td>
						<td style="padding: 4px; border: 1px solid black;">{{ $attendance->close }}</td>
...
<td style="padding: 4px; border: 1px solid black;">Absent</td>
