...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">New Account Creation Email (Batch)</li>
      </ol>
</section>
...
<div class="box-header with-border">
  <h3 class="box-title">NEW BATCH ACCOUNT CREATION EMAIL</h3><br/><br/>
<strong class="text-red">* Kindly note that staff CSV upload should be in the format of this attached sample CSV file</strong> <br/><a class="" href="{{url('/download/sample_csv_batch_email_sending.csv')}}"><i class="fa fa-download"></i> Download Sample CSV file</a>
</div>     
<div class="box-body">
          <div class="row">
...
<form id="form" method = 'POST' action = '{!!url("store_new_batch_email_account_creation")!!}' enctype="multipart/form-data">
    @csrf
