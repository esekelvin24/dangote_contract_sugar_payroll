...
@if($permit_check ==1)
     <a href="{{ url('/edit_user/'.$user_details->id) }}"><button type="button" class="btn btn-sm btn-flat btn-default"><span class="btn-label"><i class="fa fa-edit"></i></span> Edit</button></a>

    <a href="{{ url('/reset_credentials/'.$user_details->id) }}"><button type="button" class="btn btn-sm btn-flat btn-default"><span class="btn-label"></span> Change Password</button></a>

     <a href="{{ url('/assign_permissions_to_user/'.$user_details->id) }}"><button type="button" class="btn btn-sm btn-flat btn-default"><span class="btn-label"></span> Assign Special Permissions to user</button></a>
@endif    
</div>     
<div class="box-body">
          <div class="row">
