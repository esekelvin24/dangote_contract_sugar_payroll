                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                                            ...
                                            <input readonly id="date_of_birth"  autocomplete="off"  placeholder="e.g 1980-08-28" name = "date_of_birth" type="text" class="date_format form-control" 
                                            value="<?php
              ...
              <div class="box-body">
                    <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('years_of_experience_prior') ? ' has-error' : '' }}">
                                            ...
                                            <input id="years_of_experience_prior" name = "years_of_experience_prior" type="number" class="form-control" value="{{ $user_details->years_of_experience_prior}}" >
                    ...
                    <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('date_of_joining_in_refinery') ? ' has-error' : '' }}">
                                          ...
                                          <input readonly placeholder="e.g 1980-08-28" id="date_of_joining_in_refinery" name = "date_of_joining_in_refinery" type="text" class="date_format form-control" 
                                          value="<?php
                      ...
                      <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('home_town') ? ' has-error' : '' }}">
                                  ...
                                  <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                              <label for="designation">Phone Number</label> <span class="text-danger" style="font-size:17px; margin-top:3px;"><strong>*</strong></span>
