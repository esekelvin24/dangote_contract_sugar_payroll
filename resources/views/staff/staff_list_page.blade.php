                  ...
                  <div class="col-sm-12">
                    <div class="panel panel-default card-view">
                        ...
                        <div class="row">
                                ...
                                <div style="max-width:145px !important;" class="col-lg-2">
                                        <div class="form-group mb-0">
                                            <label class="control-label mb-10 text-left">Gender</label>
                                            <select id="gender" name="gender" class="form-control" data-placeholder="Choose a Category" tabindex="1">
                                 ...
                                 <div style="max-width:165px !important;" class="col-lg-2">
                                        <div class="form-group mb-0">
                                            ...
                                            <select id="status" name="status" class="form-control" data-placeholder="Choose a Category" tabindex="1">
                                                   ...
                                                   <option value="0">Pending Staff</option>
                                                   <option value="2">Deactivated Staff</option>
                                           </select>
                                        </div>
                                 </div>
                    ...
                    <div class="row" align="left" >
                        <div style="padding-top:10px; padding-left:15px;" class="input-group-btn">
                                    ...
                                    <ul class="dropdown-menu">
                                       <li><a onclick="take_action_blk('1')" href="javascript:void(0)">Activate</a></li>
                                        <li><a onclick="take_action_blk('2')" href="javascript:void(0)">Deactivate</a></li>
                                    </ul>
                            </div>

                        <div class="col-lg-1" >
                                <div class="form-group mb-0" style="margin-top:30px">
                                    <a id="add-option" class="btn btn-primary " href="{{url("/print-time-sheet")}}"><i class="icon-printer mr-5"></i>Print Time Sheet</a>
                        </div>   
                        </div>

                        <div class="col-lg-1" >
                                <div class="form-group mb-0" style="margin-top:30px; margin-left:70px;">
                                    <a id="add-option" class="btn btn-success " href="{{url("/staff-list/new-staff")}}"><i class="icon-user mr-5"></i> New Staff</a>
                                </div>   
                        </div>
                    </div>
                     ...
                     // serverSide: true,
                        ...
                        columns: [
                            ...
                            if(data.status == 0) 
                                       ...
                                       {
                                           return '<font class="txt-danger">Deactivated</font>';
                                       }
                              } 
                            },
                            ...
                            render: function(data){
                                    ...
                                    var delete_button = '<a id="' + data.staff_id + '" onclick="take_action_blk(\''+data.staff_id+'\')" href="javascript:void(0)" class="text-danger"><icon class="fa fa-trash"></icon> </a>';
                                    return edit_button ;
                                }
                            }
