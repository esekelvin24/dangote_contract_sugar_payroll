...
<div class="container-fluid">
        ...
        <div class="row heading-bg">
                ...
                <h5 class="txt-dark">Staff Creation</h5>
                </div>
                <!-- Breadcrumb -->
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="/user-list">Staff List</a></li>
                    <li class="active"><span>New Staff</span></li>
                </ol>
                </div>
                <!-- /Breadcrumb -->
        </div>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-wrap">
                                            <form method="POST" action="{{url("/new-staff/save")}}">
                                                ...
                                                <div class="form-body">
                                                        ...
                                                        <div class="row">
                                                                          ...
                                                                          <select onchange="get_section(this.value)" id="department_id" name="department_id" class="form-control" data-placeholder="Choose a Department" tabindex="1">
                                                                              ...
                                                                              @if(count($dept_array_list) > 0)
                                                                                @foreach ($dept_array_list as $department_arr)
                                                                                      <option {{ old('department_id')==$department_arr->department_id?"selected":"" }} value="{{$department_arr->department_id}}">{{$department_arr->department_name}}</option>
                                                                                @endforeach
                                                                              @endif
                                                              ...
                                                              <div style="max-width:190px !important;" class="col-md-3">
                                                                  <div class="form-group @error('creation_type') has-error @enderror">
                                                                      <span class="txt-danger" style="font-size:19px;">*</span> <label class="control-label mb-10">Creation Type</label>
                                                                      <select onchange="get_staff_id(this.value)" name="creation_type" id="creation_type" class="form-control" required>
                                                                          
                                                                          <option {{ old('creation_type')=="new"?"selected":"" }}  value="new">New</option>
                                                                          <option {{ old('creation_type')=="existing"?"selected":"" }} value="existing">Existing</option>
                                                                      </select>
                                                                      @error('creation_type')
                                                                              <span class="help-block" role="alert">
                                                                                  <strong>{{ $message }}</strong>
                                                    ...
                                                    <div style="max-width:165px !important;" class="col-md-3">
                                                            <div class="form-group @error('engagement_date') has-error @enderror">
                                                                ...
                                                                <input required autocomplete="off" name="engagement_date" id="engagement_date" type="text" class="form-control @error('engagement_date') is-invalid @enderror" value="{{ old('engagement_date') }}" placeholder="yyyy-mm-dd">
                                                    ...
                                                    <div class="row">
                                                        <div style="max-width:180px !important;" class="col-md-3">
                                                            <div  class="form-group @error('name') has-error @enderror">
                                                                <span class="txt-danger" style="font-size:19px;">*</span> <label class="control-label mb-10">Staff ID </label>
                                                                <input disabled type="text" id="staff_id" name="staff_id" class="form-control" value="{{ old('staff_id') }}" placeholder="Enter Staff ID" required autocomplete="name" autofocus>
                                                                @error('name')
                                                                    <span class="help-block" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div style="max-width:180px !important;" class="col-md-3">
                                                            <div class="form-group @error('first_name') has-error @enderror">
                                                                ...
                                                                <span class="txt-danger" style="font-size:19px;">*</span> <input type="text" id="first_name" name="first_name" class="form-control" value="{{ old('first_name') }}" placeholder="Enter First Name" required autocomplete="name" autofocus>
                                                                @error('first_name')
                                                                    <span class="help-block" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div style="max-width:180px !important;" class="col-md-3">
                                                            <div class="form-group @error('last_name') has-error @enderror">
                                                                ...
                                                                <input type="text" id="last_name" name="last_name" class="form-control" value="{{ old('last_name') }}" required autocomplete="lastname"  placeholder="Enter Last Name">
                                                                @error('last_name')
                                                                    <span class="help-block" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div style="max-width:180px !important;" class="col-md-3">
                                                            <div class="form-group @error('othername') has-error @enderror">
                                                                ...
                                                                <input type="text" id="othername" name="othername" class="form-control" value="{{ old('othername') }}"  placeholder="Enter Other Name">
                                                                @error('othername')
                                                                    <span class="help-block" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                    ...
                                                    <div style="max-width:180px !important;" class="col-md-3">
                                                            <div class="form-group @error('gender') has-error @enderror">
                                                                ...
                                                                <select name="marital_status" id="marital_status" class="form-control" required>
                                                                    ...
                                                                    <option {{ old('marital_status')=="Seperated"?"selected":"" }} value="Seperated">Seperated</option>
                                                                </select>
                                                                @error('gender')
                                                                        <span class="help-block" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                    ...
                                                    <div style="max-width:140px !important;" class="col-md-3">
                                                        <div class="form-group @error('dob') has-error @enderror">
                                                            ...
                                                            <input required autocomplete="off" name="dob" id="dob" type="text" class="form-control @error('dob') is-invalid @enderror" value="{{ old('dob') }}" placeholder="yyyy-mm-dd">
                                                    ...
                                                    <div class="row">
                                                                    ...
                                                                    <div class="form-group mb-0">
                                                                        ...
                                                                        <select onchange="get_desig(this.value)" required id="category_id" name="category_id" class="form-control" data-placeholder="Choose a Designation" tabindex="1">
                                                                            ...
                                                                            @foreach ($cat_array_list as $cat_arr)
                                                                                    <option {{ old('category_id')==$cat_arr->category_id?"selected":"" }} value="{{$cat_arr->category_id}}">{{$cat_arr->category_name}}</option>
                                                                            @endforeach
                                                                            @endif
                                                            ...
                                                            <div style="max-width:150px !important;" class="col-md-3">
                                                                    <div class="form-group @error('designation_salary') has-error @enderror">
                                                                        ...
                                                                        <input readonly type="text" id="designation_salary" name="designation_salary" class="form-control" value="{{ old('designation_salary') }}"  autocomplete="designation_salary"  placeholder="">
                                                                ...
                                                                <div style="max-width:150px !important;" class="col-md-3">
                                                                        <div class="form-group @error('additional_bonus') has-error @enderror">
                                                                            ...
                                                                            <input type="text" id="additional_bonus" name="additional_bonus" class="form-control" value="{{ old('additional_bonus') }}"  autocomplete="additional_bonus"  placeholder="">
                                                 ...
                                                 <div class="row">
                                                        ...
                                                        <div style="max-width:180px !important;" class="col-md-3">
                                                                <div class="form-group @error('email') has-error @enderror">
                                                                    ...
                                                                    <input type="text" id="email" name="email" class="form-control" value="{{ old('email') }}"  autocomplete="email"  placeholder="Enter Email">
                                                                    @error('email')
                                                                        <span class="help-block" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                    ...
                                                    <div style="max-width:190px !important;" class="col-md-3">
                                                        <div class="form-group @error('phone') has-error @enderror">
                                                            ...
                                                            <input required autocomplete="off" name="phone" id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" placeholder="Enter Phone Number">
                                                    ...
                                                    <div class="col-md-4">
                                                            <div class="form-group @error('address') has-error @enderror">
                                                                ...
                                                                <input required autocomplete="off" name="address" id="address" type="text" class="form-control @error('address') is-invalid @enderror" value="{{ old('addres') }}" placeholder="Enter user address">
                                                 ...
                                                 <div class="row">
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            @if(count($bank_list) > 0)
                                                               @foreach($bank_list as $bank)
                                                                    <option value="{{$bank->bin_code}}">{{$bank->bank}}</option>
                                                              @endforeach
                                                            @endif
                                                        </select>
                                                        @error('bank_id')
                                                    ...
                                                    <div style="max-width:220px !important;" class="col-md-3">
                                                        <div  class="form-group @error('account_no') has-error @enderror">
                                                            ...
                                                            <input required autocomplete="off" name="account_no" id="account_no" type="text" class="form-control @error('account_no') is-invalid @enderror" value="{{ old('account_no') }}" placeholder="Enter Bank Account Number">
                                                    ...
                                                    <div class="col-md-2">
                                                            <div style="max-width:220px !important;" class="form-group @error('account_name') has-error @enderror">
                                                                ...
                                                                <input required autocomplete="off" name="account_name" id="account_name" type="text" class="form-control @error('account_name') is-invalid @enderror" value="{{ old('account_name') }}" placeholder="Enter Bank Account Name">
                                                        ...
                                                        <div class="col-md-4">
                                                                <div style="max-width:220px !important;" class="form-group @error('bvn') has-error @enderror">
                                                                    ...
                                                                    <input required autocomplete="off" name="bvn" id="bvn" type="text" class="form-control @error('bvn') is-invalid @enderror" value="{{ old('bvn') }}" placeholder="Enter Account BVN">
