...
<div class="container-fluid">
    ...
    <div class="row heading-bg">
            ...
            <h5 class="txt-dark">Approve Departmental Monthly Payroll</h5>
            </div>
            <!-- Breadcrumb -->
...
<script>
                     ...
                     // serverSide: true,
                        ...
                        columns: [
                            ...
                            render: function(data){
                                ...
                                if (data.status == 0)
                                {
                                    add_button = '<a id="' + data.sheet_id + '" href="javascript:approve_payroll(\''+ data.payroll_id +'\')" class="text-success"><icon class="fa fa-check"></icon> Approve Payroll </a>';
                                   
                                }
                                    
                                   
                                    var view_button = '<a target="blank" id="' + data.cat_group_id + '" href="'+SITEURL+'/payroll-list/payroll-id/' + data.payroll_id + '/" class="text-primary"><icon class="fa fa-eye"></icon> View </a>'
    ...
    @if (Session::get('error'))
     ...
     function approve_payroll(payroll_id)
     {
               ...
               $.post( SITEURL + "/approve_payroll",
                        ...
                        function(data, status){
                         ...
                         console.log(data);
                            swal({
                                title: "Successful",
                                text: "Payroll approval was successfully",
                                icon: "success",
                                button: "Ok",
                                });
                             $('#datable_1').DataTable().ajax.reload();
