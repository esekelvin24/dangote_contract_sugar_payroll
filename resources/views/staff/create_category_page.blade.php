...
<div class="container-fluid">
        ...
        <div class="row heading-bg">
                ...
                <h5 class="txt-dark">New Job Category</h5>
                </div>
                <!-- Breadcrumb -->
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    <li><a href="/category-list">Job Category List</a></li>
                    <li class="active"><span>New Job Category</span></li>
                </ol>
                </div>
                <!-- /Breadcrumb -->
        </div>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-wrap">
                                            <form  method="POST" action="{{url('/category-list/save')}}">
                                                    ...
                                                    <div class="row">
                                                            <div style="max-width:250px !important;" class="col-md-6">
                                                                    <div class="form-group @error('new_date') has-error @enderror">
                                                                        <span class="txt-danger" style="font-size:19px;">*</span> <label class="control-label mb-10">Job Category Name</label>
                                                                        <input value="{{$category_name==""?"":$category_name}}" type="text" id="category_name" name="category_name" class="form-control"  placeholder="Enter the Job Category Name" required autofocus>
                                                                        @error('new_date')
