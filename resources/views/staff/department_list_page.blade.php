...
<div class="container-fluid">
    ...
    <div class="row heading-bg">
            ...
            <h5 class="txt-dark">Department List</h5>
            </div>
            <!-- Breadcrumb -->
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group mb-0">
                                                     <div style="padding-top:5px;" class="">   
                                                            <a class="btn btn-success" href="{{url('/department-list/new/create')}}"><i class="icon-plus mr-20"></i>Create New Department</a>
                                                       </div>
                                                </div>
                                            </div>
                                        </div>
          ...
          table = $('#datable_1').DataTable({
                     ...
                     // serverSide: true,
                        ...
                        columns: [
                            ...
                            render: function(data){
                                    var checkbox = '<div class="checkbox"><input onClick="ff()" value="'+ data.department_id +'" type="checkbox"><label for="checkbox1"></label></div>';
                                    return checkbox;
                                }
                            },        
                            ...
                            {data: null, orderable: false,searchable: false,
                            render: function(data){                                            
                                    var edit_button = '<a id="' + data.department_id + '" href="'+SITEURL+'/department-list/update/'+data.department_id+'" class="text-primary"><icon class="fa fa-pencil"></icon> Edit</a>';
                                    var delete_button = '<a id="' + data.department_id + '" onclick="take_action_blk(\''+data.department_id+'\')" href="javascript:void(0)" class="text-danger"><icon class="fa fa-trash"></icon> Update</a>';
            ...
            //individual checking of checkbox
                ...
                function take_action_blk(id)
                {
                    ...
                    $.ajax({
                        type: "get",
                        url: SITEURL + "/department-list-delete/"+app_ids,
                        success: function (data) {
                            //alert(SITEURL + "/department-list-delete/"+app_ids);
                            $('#datable_1').DataTable().ajax.reload();
                        },
                        error: function (data) {
