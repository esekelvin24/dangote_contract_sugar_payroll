...
@section('title') Trainee Log List @endsection
@section('content')
    ...
    Approve Trainee Log
       ...
       <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-users" style="color: blue;"></i> Trainee Log List</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="row">
              <br/>
            <form method="GET" action="{{url('/approve_trainee_log')}}">
                    ...
                    @foreach ($report_lists as $val)  
                      ...
                      <td>{{$counter + 1}}</td>
                         ...
                         <td>
                          ...
                          <a href="{{ url('trainee_log_details/'.base64_encode($val->schedule_id)) }}"  ><button type="button" class="btn btn-default btn-sm btn-flat" title="Info"><span class="btn-label"><i class="fa fa-info-circle"></i></span> View Log</button></a>
