	...
	<div class="content-box">
		<div class="element-wrapper">
			<h6 class="element-header">
				All Students Result List (@if( !isset($student_collection) || $student_collection->isEmpty() ) 0 @else{{$student_collection->count()}}@endif)
			</h6>
					...
					<table id="dataTable1" class="table table-striped" style="width: 100% !important;">
						...
						@foreach($student_collection as $val)
							<tr>
								...
								<td><a href="{{route('view_other_studentt_result' ,base64_encode($val->user_id))}}" class="btn btn-info">View Result</a></td>
							</tr>
							<?php $a++ ?>
						@endforeach
                        @else
