                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td class="h2" style="padding: 5px 0 0 0; color: white">
                        D.A.S Regularisation Rollback Triggered
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td class="bodycopy">
					<div>
						...
						<p>The regularisation for {{$month_of}} has been rollback for <strong>{{$full_name}}</strong> due to the reason given below</p>
						<p>This staff will have to meet all requirements stated on the reason below and then re-submit a new regularisation for the month of {{$month_of}}</p>
					
						<p>Reg ID : {{$full_uniq_reg_id}}</p>
						<p>Staff Biometric No : {{$biometric_no}}</p>
						<p>Staff Name : {{$full_name}}</p>
						<p>Rollback By : {{$rollback_by}}</p>
