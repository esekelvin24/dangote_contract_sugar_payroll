          ...
          <td class="innerpadding borderbottom">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="bodycopy">
                  <br/>
                  Your IAUE Portal account has been activated successfully. <br/><br/>
                  You may now login into your account to get started.
                </td>
              </tr>
                        ...
                        <table class="buttonwrapper" bgcolor="#ffc000" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td class="button" height="45">
                              <a target="_blank" href="{{$link}}">Login</a>
                            </td>
                          </tr>
                        </table>
                      </td>
