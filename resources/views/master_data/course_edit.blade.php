...
<div class="content-box">
    ...
    <div class="row">
        <div class="col-sm-12">
                <form id="form" action="{{route('save_edited_course')}}" method="post"  role="form">
               @csrf

               @foreach ($course_collection as $cour)
                   
                <input required id="course_id" name="course_id" value="{{$cour->course_id}}" type="hidden" >
               <div>
                <div class="row">
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{$cour->course_title}}" autocomplete="off" class="form-control underline" required id="course_title" placeholder="Enter Course Title" type="text" name="course_title">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{$cour->unit}}" autocomplete="off" class="form-control underline" required id="credit_unit" placeholder="Enter Credit Unit" type="text" name="credit_unit">
                                <span class="text-danger error-message here"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select required autocomplete="off" class="form-control" id="category"  name="category">
                                    ...
                                    <option {{$cour->category==1?'selected':''}} value="1">Mandatory</option>
                                    <option {{$cour->category==2?'selected':''}} value="2">Elective</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    @php
                    $prog_id = $course_collection[0]->programme_id;
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select required name="semester" id="semester" class="form-control underline">
                                    <option {{$cour->semester==1?"selected":""}} value="1">1</option>
                                    <option {{$cour->semester==2?"selected":""}} value="2">2</option>
                                </select>
                                <span class="text-danger error-message here"></span>
                            </div>
                        </div>
