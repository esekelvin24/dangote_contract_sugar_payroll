...
$regularisation_list_hod_pending = Regularisation::where('submitted',1)->where('user_id', $get_user_id)->where('hr_status', '=', 0)->where('hod_approver_status', '=', 0)->pluck('date_to_regulate','date_to_regulate')->toArray();
$regularisation_list_hod_approved = Regularisation::where('submitted',1)->where('user_id', $get_user_id)->where('hr_status', '=', 0)->where('hod_approver_status', '=', 1)->pluck('date_to_regulate','date_to_regulate')->toArray();
$regularisation_list_hod_rejected = Regularisation::where('submitted',1)->where('user_id', $get_user_id)->where('hr_status', '=', 0)->where('hod_approver_status', '=', 2)->pluck('date_to_regulate','date_to_regulate')->toArray();
...
$regularisation_list_hr_approved = Regularisation::where('submitted',1)->where('user_id', $get_user_id)->where('hod_approver_status', '=', 1)->where('hr_status', '=', 1)->pluck('date_to_regulate','date_to_regulate')->toArray();
$regularisation_list_hr_rejected = Regularisation::where('submitted',1)->where('user_id', $get_user_id)->where('hod_approver_status', '=', 1)->where('hr_status', '=', 2)->pluck('date_to_regulate','date_to_regulate')->toArray();
////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////
        ...
        if($attendance_month == "all"){
            ...
            $start = new Carbon('first day of '.$attendance_month);
            $start->startOfMonth();
            $end = new Carbon('last day of '.$attendance_month);
            $end->endOfMonth();
            $attendances = Attendance::where('user_sap', $sap_no)->where("attendance_date", '>=', $start)->where("attendance_date", '<=', $end)->orderBy('attendance_date', 'desc')->get();
        }
        
      
        $html = view('attendance.my_attendance_month_view', compact('attendances', 'leave_array', 'validated_array', 'monthsOfYear', 'holidays_list', 'regularisation_list_hod_pending', 'regularisation_list_hod_approved', 'regularisation_list_hod_rejected', 'regularisation_list_hr_pending', 'regularisation_list_hr_approved', 'regularisation_list_hr_rejected', 'leave_request_list_hod_pending', 'leave_request_list_hod_approved', 'leave_request_list_hod_rejected', 'leave_request_list_hr_pending', 'leave_request_list_hr_approved', 'leave_request_list_hr_rejected'))->render();
        return  $html;
    }
