...
INSERT INTO `gendata` VALUES ('payroll', 15);
INSERT INTO `gendata` VALUES ('payroll_cat_id', 2679);
INSERT INTO `gendata` VALUES ('timesheet', 87);
...
CREATE TABLE `payroll_staff_record`  (
  ...
  `daily_net_salary` decimal(10, 2) NULL DEFAULT NULL,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (23, 'Ese', 'Uvbiekpahor', '', 'male', 'ese.kelvin@dangoteprojects.com', '1980-11-01', NULL, '$2y$10$nwzzZujg9gyVeYwpjMv6aOXk5Gsfrjb/xBhIqhr6RE.IK.hTvmHeO', '08097191027', '0', NULL, NULL, NULL, NULL, '1', '1', '1', '1', '1', '1', '1', '1', NULL, NULL, NULL, NULL, 'ese.kelvin@dangoteprojects.com', '5UQ4rVlwpwCEbzNUIAD9VCVkCrEfvY7sPJig84nQ2RRM5GALc0Ai50ljkkBl', '2019-09-17 23:51:27', '2019-12-08 01:31:45', 'dep06', 1);
...
payroll_creation.pay_day,
payroll_staff_record.daily_net_salary,
payroll_creation.staff_type_id
FROM
payroll_creation
LEFT JOIN payroll_staff_record ON payroll_staff_record.payroll_id = payroll_creation.payroll_id
