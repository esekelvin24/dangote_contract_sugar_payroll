...
Route::group(['middleware'=>['auth']], function(){
   ...
   Route::group(['middleware'=>['admin']], function(){
        ...
        Route::get('/enable-staff/{staff_id}', 'Staff\StaffController@enable_staff')->name('11~/enable-staff');//menu_id~menu_name
        ...
        Route::get('/time-sheet-list/delete/{op}', 'Staff\StaffTimeSheetController@time_sheet_delete')->name('15~/time-sheet-list/capture');//menu_id~menu_name
       ...
       Route::post('/approve_payroll', 'Staff\PayrollController@approve_payroll')->name('20~/approve_payroll');
